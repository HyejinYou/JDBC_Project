...
public class PwmatchproblemError {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PwmatchproblemError window = new PwmatchproblemError();
	...
	private void initialize() {
		...
		lblNewLabel_1.setBounds(62, 10, 52, 15);
		...
		lblNewLabel.setBounds(32, 35, 403, 25);
		frame.getContentPane().add(lblNewLabel);

		JButton btnClose = new JButton("\uD655\uC778");
		btnClose.setBounds(340, 100, 95, 23);
